...
//            bidOrder = retrieve(rs).get(0);
    ...
    @Override
	public List<BidOrder> selectByMbrID(Integer mbrID) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        List<BidOrder> list = null;
...
//      BidOrderDao bidOrderDao = new BidOrderDaoImpl();
//      List<BidOrder> list = bidOrderDao.selectByOrderDate(Timestamp.valueOf("2022-06-28 00:00:00"), Timestamp.valueOf("2022-07-04 23:00:00"));
//      System.out.println(list);
    	
      BidOrderDao bidOrderDao = new BidOrderDaoImpl();
      List<BidOrder> list = bidOrderDao.selectShipStat(0);
      System.out.println(list);
