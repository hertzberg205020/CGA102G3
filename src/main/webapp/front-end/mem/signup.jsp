					...
					<table>
						...
						<tr>
							...
							<td class="td_right"><input label="E-mail"
								required="required" type="text"  name="email" id="email" value="<%=(memVO == null) ? "請輸入Email" : memVO.getMbrEmail()%>"/></td>
						</tr>
						...
						<tr>
							...
							<td class="td_right"><input label="姓名" required="required" type="text"
								name="name" id="name" value="<%=(memVO == null) ? "請輸入姓名" : memVO.getMbrName()%>"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="td_right"><input label="手機號碼" required="required" type="text"
								name="phone" id="phone" value="<%=(memVO == null) ? "請輸入手機號碼" : memVO.getMbrMobile()%>"/></td>
						</tr>
						...
						<tr>
							...
							<td class="td_right">
								...
								type="text" required="required" name="address" id="address" value="<%=(memVO == null) ? "請輸入住址" : memVO.getMbrAddr()%>"/>
							</td>
						</tr>
						<tr>
							...
							<td class="td_right"><input label="生日" required="required" type="date"
								name="date" id="date" value="<%=(memVO == null) ? "請選擇日期" : memVO.getMbrBirth()%>"></td>
						</tr>
