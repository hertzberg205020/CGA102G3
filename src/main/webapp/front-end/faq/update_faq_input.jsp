...
<table>
	...
	<tr>
		<td><b>關於常見問題　</b></td>
		<td><input  disabled type="TEXT" name="ques" size="60" value="<%=faqVO.getQues()%>"　 /></td>
	</tr>
	<tr>
		<td><b>我的回覆是　</b></td>
	...
	<tr>
		<td>
		 <button type="button" class="btn btn-danger"
                 onclick="javascript:location.href='${pageContext.request.contextPath}/front-end/faq/listAllFaq.jsp'">
                 取消回覆
         </button>
         	</td>
	</tr>
...
<input type="submit" class="btn btn-success" value="送出我的回覆">
</td>
	</tr>
