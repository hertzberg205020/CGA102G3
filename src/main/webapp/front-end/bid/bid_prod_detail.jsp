...
<%--    </nav>--%>
    ...
    <div class="section-info row mb-5">
        ...
        <div class="col-md mt-2">
            ...
            <img src="${pageContext.request.contextPath}/static/images/books/${book.bookID}.jpg" width="90%" id="pic" data-toggle="modal" data-target="#Modal-1" border="1px solid black">
            <!-- model -->
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="pic-enlarge">
                                <img src='${pageContext.request.contextPath}/static/images/books/${book.bookID}.jpg' width="100%">
                            </div>
                        </div>
                    </div>
                </div>
...
<%--                <span style="font-size: 20px; color:slategrey;">(二手書)</span>--%>
            ...
            <div class="general ml-3 mb-4 mr-3 ">
                ...
                <div class="pubdate mb-2 mt-3">出版日期: <fmt:formatDate value="${book.pubdate}" pattern="yyyy-MM-dd"/></div>
                <div class="direct-price mb-2 mt-3">直購價: <span style="color:goldenrod; font-weight:bold;" id="bidDirectPrice">${bidActivity.bidDirectPrice}</span>元</div>
                <div class="direct-price mb-2 mt-3">底價: <span style="color:goldenrod; font-weight:bold;" id="bidStartPrice">${bidActivity.startPrice}</span>元</div>
<%--                <div class="cur-price mb-2 mt-3">目前出價: <span style="font-size: 24px; color: royalblue; font-weight: 500;">300</span>元</div>--%>
            ...
            <div class="general ml-3 mb-4 mr-3 ">
                ...
                <div class="cur-price mb-2 mt-3"><span style="font-size: 24px; color: royalblue; font-weight: 500;" id="curBidPrice"></span>元</div>
                <div class="cur-price mb-2 mt-3"> 出價會員編號: <span style="font-size: 24px; color: royalblue; font-weight: 500;" id="curWinnerID"></span></div>
            </div>
        ...
        <div class="col-md ml-2">
            <div class="bid">
                ...
                <form class="form-inline">
                    <div>
                        <input class="form-control mr-1" type="number" id="bidPrice" min="1" step="10" placeholder="請輸入金額">
                        <div class="invalid-feedback" id="warn"></div>
                        <div class="valid-feedback"></div>
                    </div>
                    <div class="w-100"></div>
                    <button class="form-control btn btn-warning mt-2" id="offerPriceBtn">我要出價 <i class="bi bi-coin"></i></button>
                </form>
...
<%--                <span class="align-middle">數量 = 1</span>--%>
                <button type="button" class="btn btn-outline-info btn-lg ml-2" id="directGetBtn"> <i class="bi bi-bag-heart-fill"></i> 直接購買</button>
            </div>
        </div>
    </div>
