        ...
        <nav class="nav">
            ...
            <c:if test="${AdminAuthVO.authID == 1}">
                <li>
                    ...
                    <ul>
                        <li><a id="a" href ="${pageContext.request.contextPath}/back-end/emp/select_page.jsp">員工帳號管理</a></li>
                        <li><a id="a" href ="${pageContext.request.contextPath}/back-end/emp/listAdminAuth.jsp">員工權限管理</a></li>
                    </ul> 
                </li>
                </c:if>
                ...
                <li>
                    ...
                    <ul>
                        <li><a id="a" href ="${pageContext.request.contextPath}/back-end/mem/listAllMember.jsp">會員資料</a></li>
               ...
               <c:if test="${AdminAuthVO.authID == 3}">
                ...
                <li>
                    <img class="img2" src="${pageContext.request.contextPath}/static/images/cs2.png" height="20px" width="20px">
