...
<%-- 			 value="<%= (noteVO==null)? "1" : noteVO.getNote_content_type()%>" /></td> --%>
	...
	<option value="<%= (noteVO==null)? "9" : noteVO.getNote_content_type()%>" >管理員公告</option>
				...
				<tr>
					<td>
						<button type="button" class="btn btn-danger"
							onclick="javascript:location.href='${pageContext.request.contextPath}/back-end/note/listAllNote.jsp'">
							取消留言</button>
					</td>
				<tr>
					<td><input type="hidden" name="action" value="insert">
						<input type="submit" class="btn btn-success" value="送出留言"></td>
				</tr>
</FORM>
</div>
<br><br><br><br><br><br>
