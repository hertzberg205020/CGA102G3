...
<body>
	...
	<main class="main">
		<div class="table_container">
			...
			<jsp:useBean id="bookSvc" scope="page" class="com.cga102g3.web.book.service.impl.BookServiceImpl"/>							
				<c:forEach var="prodVO" items="${titleList}">
					<tbody>
						<tr>
						<th scope="row" style="vertical-align:middle">${prodVO.prodID}</th>
							...
							<td style="vertical-align:middle">${bookSvc.getBookById(prodVO.bookID).title}</td>
