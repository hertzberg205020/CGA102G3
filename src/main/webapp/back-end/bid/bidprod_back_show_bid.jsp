...
<%
	...
	Integer bidProdStat = (Integer) request.getSession().getAttribute("bidProdStat");
	
	List<BidProd> list = bs.showOneStat(2);
				...
				<tbody>
					...
					<tr class="prodList">
						<th class="header-row" scope="row">${bidProd.bidID} <a
							href="${pageContext.request.contextPath}//bid/participate/getOneBid?bidID=${bidProd.bidID}"
