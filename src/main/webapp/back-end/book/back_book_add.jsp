...
<%--        回書籍查詢頁面--%>
        ...
        <form class="align-items-start form-row" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/book/edit">
            <input type="hidden" name="action" value="insert">
            <input type="hidden" id="prefix" value="${pageContext.request.contextPath}">
            <div class="form-group col-6">
                <label for="title">書名</label>
                <input type="text" id="title" name="title" class="form-control is-invalid" placeholder="請輸入書名" required>
                <div class="invalid-feedback">必提項目</div>
                <div class="valid-feedback"></div>
            </div>
            <div class="form-group col-6">
                <label for="ISBN">ISBN-13</label>
                <input type="text" id="ISBN" name="ISBN" class="form-control is-invalid" placeholder="ISBN-13" required>
                <div class="invalid-feedback">必提項目</div>
                <div class="valid-feedback"></div>
            </div>
            ...
            <div class="form-group col-4">
                ...
                <input type="number" id="edition" name="edition" class="form-control" placeholder="請輸入版次" value="1" min="1" max="50" step="1" required>
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control is-invalid" id="author" name="author" placeholder="請輸入作者" required>
...
<%--                <img src="${url}" id="fileImg" class="">    --%>
            ...
            <button class="btn btn-primary ml-auto mr-1" type="submit" id="submit_btn" disabled>Submit form</button>
        </form>
    </div>
