...
<!----------------------- Search By Order ID, Shipment Management -------------------------------->
			<div class="row">
				...
				<div class="col-3 mt-4 text-secondary">${errMsgsOrd[0]}</div>
			...
			<div class="row">
				<div class="col-3">
					<form method="post" action="bidOrder.do" class="form-inline mb-4">
						...
						<div class="input-group ml-2">
							<input type="text" id="input2" class="form-control" name="mbrName"
								placeholder="Find by Member">
							<div class="input-group-append">
								<input type="hidden" name="action" value="showMbrName">
				...
				<div class="col-3 mt-4 text-secondary">${errMsgsMbr[0]}</div>
			</div>
			
			
<!-------------------------  Search by Order Date Range-------------------------------------------------->
			<div class="row" style="height: 26px;">
				<div class="col-2 offset-5 mb-1 text-secondary">${errMsgsDate[0]}</div>
