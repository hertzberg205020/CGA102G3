...
<%
	...
	Timestamp bidStart = (Timestamp) request.getAttribute("startDate");
	Timestamp bidEnd = (Timestamp) request.getAttribute("endDate");
	List<BidOrder> list = bs.showDate(bidStart,bidEnd);
// 	System.out.println(bidStart + "-" + bidEnd);
